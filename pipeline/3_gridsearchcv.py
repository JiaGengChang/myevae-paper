...
def main(
    ...
    if fulldata:
        ...
        train_features_file=f'{splitsdir}/full_features_{endpoint}_processed_joint_impute.parquet'
        ...
        train_features_file=f'{splitsdir}/{params.shuffle}/{params.fold}/train_features_{endpoint}_processed_joint_impute.parquet'
        train_labels_file=f'{splitsdir}/{params.shuffle}/{params.fold}/train_labels.parquet'
        valid_features_file=f'{splitsdir}/{params.shuffle}/{params.fold}/valid_features_{endpoint}_processed_joint_impute.parquet'
