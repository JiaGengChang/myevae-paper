"""
Jia Geng 21 April 2025
Monkey patched version of [venv_folder]/lib/python3.12/site-packages/shap/explainers/_deep/deep_pytorch.py
Allows list of tensors as input to our custom ShapMultiModalVAE torch.nn.Module
The single list of tensors is [X_exp, X_cna, X_gistic, X_fish, X_sbs, X_ig, X_clin]
The subtask tensors are always at the end
They will be parsed by the __call__ function ShapMultiModalVAE class into [Xs_VAE, Xs_subtask] which is the required format for MultiModalVAE
