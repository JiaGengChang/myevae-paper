...
class VAEParams:
    ...
    def __init__(self,endpoint='pfs',shuffle=0,fold=0):
        ...
        self.resultsprefix = f'/home/users/nus/e1083772/cancer-survival-ml/output_scratch/vae_zero_impute_naive/{self.model_name}/{self.endpoint}_shuffle{self.shuffle}_fold{self.fold}'
