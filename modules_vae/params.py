...
class VAEParams:
    ...
    def __init__(self,endpoint='pfs',shuffle=0,fold=0):
        ...
        self.resultsprefix = f'/Users/jiageng/Projects/myevae-paper/output/vae_models/zero_impute_mask_aware/{self.model_name}/{self.endpoint}_shuffle{self.shuffle}_fold{self.fold}'
